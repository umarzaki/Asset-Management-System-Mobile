...
public class AdapterDataRepair extends RecyclerView.Adapter<AdapterDataRepair.drViewHolder> {

    Context context;
    List<Result> results;

    public AdapterDataRepair(Context con, List<Result> results){
        context = con;
    ...
    public void onBindViewHolder(@NonNull drViewHolder holder, int position) {
        ...
        holder.eventName.setText(result.getNamaPemeliharaan());
        holder.Date.setText(result.getTanggalPemeliharaan());
        ...
        holder.card.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.nav_detail_repair, bundle));
    }
